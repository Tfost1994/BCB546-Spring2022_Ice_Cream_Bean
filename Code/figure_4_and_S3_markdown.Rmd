...
In this code, I wrangled the data from `Supplemental_file_5.xls`, which contains expression values of various genes in different tissues in wheat and barley, and used this code to replicated Figures 4 and S3 from Peng et al. 2015.
