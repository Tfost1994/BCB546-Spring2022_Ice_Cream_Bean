...
The `tidyverse`, `readxl`, `dplyr`, `data.table`, `janitor`, and `tibble` R libraries are required to run this code, which was written using R version 4.1.2 (2021-11-01), "Bird Hippie".
