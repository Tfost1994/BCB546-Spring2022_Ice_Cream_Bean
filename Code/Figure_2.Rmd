...
composite_with_legend <- add_sub(composite_tree, "Figure 2: Phylogeny of PEBP (a) and MADS (b) family proteins in Arabidopsis, wheat, and barley. The support value on each node is the posterior probability. \nThe scale bar denotes the number of nucleotide replacements per site", x = 0, hjust = 0)
