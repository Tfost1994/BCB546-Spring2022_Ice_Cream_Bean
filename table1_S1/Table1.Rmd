...
Update the path variable to the location of the cloned repository for this project. Path should end in "BCB546-Spring2022_Ice_Cream_Bean/"
```{r}
path <- "~/Desktop/BCB546_2022/BCB546-Spring2022_Ice_Cream_Bean/"
setwd(paste(path, "table1_tableS1", sep = ""))
```
