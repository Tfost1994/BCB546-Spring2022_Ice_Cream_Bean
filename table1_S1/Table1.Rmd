...
This Table1.Rmd file must be located at the path ending in "/BCB546-Spring2022_Ice_Cream_Bean/table1_S1". No changes necessary if this is cloned from github directly.
```{r}
if(!grepl("BCB546-Spring2022_Ice_Cream_Bean/table1_S1", here::here())) {warning("Incorrect working directory")}
```
...
save_kable(table1_kable, "Table_1.html")
```
...
tableS1_kable
save_kable(tableS1_kable, "TableS1.html")
```
